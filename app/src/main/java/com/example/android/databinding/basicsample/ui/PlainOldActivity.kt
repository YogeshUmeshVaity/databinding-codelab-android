...
class PlainOldActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // LiveData is a lifecycle-aware observable so you need to specify what lifecycle owner
        // to use. You do this in the binding object.
        // Use Fragment.viewLifecycleOwner for fragments
        binding.lifecycleOwner = this

        // Let binding object know which ViewModel to use with it.
